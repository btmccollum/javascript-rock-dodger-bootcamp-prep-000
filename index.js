...
function createRock(x) {
  ...
  rock.style.backgroundColor = '#8B4513';
...
function moveDodger(e) {
   if (e.which === LEFT_ARROW){
     moveDodgerLeft(), e.preventDefault(), e.stopPropagation();
   } 
   if (e.which === RIGHT_ARROW){
     moveDodgerRight(), e.preventDefault(), e.stopPropagation();
   }
}
 ...
 * @returns {number} The position as an integer (without 'px')h
 */
